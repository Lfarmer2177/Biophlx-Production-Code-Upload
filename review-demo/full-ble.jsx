...
import {applyFirmwareSetCount} from '../src/context/firmwareSetProgress';
let listeners=new Set();
const base={ROM:0,TUT:0,Velocity:0,Score:0,reps:0,sets:0,setc:0,exerciseStage:2,'Current Position':0};
...
export const nextSet=(slot)=>{const field=slot==='secondary'?'secondaryFeedback':'feedback';update({[field]:applyFirmwareSetCount(state[field],state[field].sets+1)});};
